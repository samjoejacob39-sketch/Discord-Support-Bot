...
export const DEFAULT_GUILD_SETTINGS = {
  supportMode: 'invoked' as const,
  aiEnabled: true,
  maxAiAttempts: 3,
} as const;

export const SUPPORT_MODES = ['invoked', 'channels', 'categories', 'all'] as const;
export type SupportMode = (typeof SUPPORT_MODES)[number];

export const SUPPORT_MODE_HELP: Record<SupportMode, string> = {
