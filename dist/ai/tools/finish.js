 ...
 */
export const respondToUser = {
    terminal: true,
    spec: {
        name: 'respond_to_user',
        description: 'Send your reply to the member and end the turn. Use it once you can actually help. The message is shown verbatim, so write it exactly as the member should read it.',
        parameters: {
            type: 'object',
            properties: {
                message: {
...
export const escalateToAdmin = {
    terminal: true,
    spec: {
        name: 'escalate_to_admin',
        description: 'Hand the conversation to human staff and stop answering. Use it when confidence is low, the member asks for a human, staff powers or private data are required, the member is upset and unhelped, or you already tried and failed.',
        parameters: {
            type: 'object',
            properties: {
                user_message: {
                    type: 'string',
                    description: 'Short, calm message to the member: what you could not resolve and that staff have been notified. No apology spiral, no promises about timing.',
                },
...
export const terminalTools = [respondToUser, escalateToAdmin];
